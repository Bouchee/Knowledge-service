...
import org.xianwu.core.exception.PrcException;
import org.xianwu.core.metatype.Dto;
import org.xianwu.core.metatype.impl.BaseDto;
import org.xianwu.core.model.dao.Dao;
import org.xianwu.core.orm.xibatis.support.SqlMapClientTemplate;
...
public class DaoImpl extends SqlMapClientDaoSupport implements Dao {
	...
	public List queryForPage(String statementName, Dto qDto) throws SQLException {
		...
		if (Utils.isNotEmpty(start)) {
			...
			qDto.put("start", 0);
			log.warn("缺失分页起始参数,后台已经为你自动赋值为\"0\"，但建议您参照标准范例，如果不是分页查询请使用queryForList()方法");
		}
		if (Utils.isNotEmpty(limit)) {
			...
			qDto.put("end", 999999);
			log.warn("缺失分终止页参数,后台已经为你自动赋值为\"999999\"，但建议您参照标准范例，如果不是分页查询请使用queryForList()方法");
		}
	...
	public void callPrc(String prcName, Dto prcDto) throws PrcException {
		...
		if (Utils.isEmpty(prcDto.getAsString("appCode"))) {
