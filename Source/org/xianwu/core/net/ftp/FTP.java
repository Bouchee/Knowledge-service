...
import org.xianwu.core.net.ProtocolCommandListener;
import org.xianwu.core.net.ProtocolCommandSupport;
import org.xianwu.core.net.SocketClient;
...
public class FTP extends TelnetClient
{
    ...
    private boolean socketIsConnected(Socket socket)
    {
        ...
        try
        {
            Method isConnected = socket.getClass().getMethod("isConnected", new Class[]{ null });
            return ((Boolean) isConnected.invoke(socket, new Object[]{ null })).booleanValue();
        }
