...
public class ExcelTemplateGenerate {
	...
	public ExcelTemplateGenerate(){
	}
	
	public static String createTemplate(String useraccount, String filepath, String headername, String headerid, String reportTitle) throws IOException, RowsExceededException, WriteException{
		String[] hna = headername.split(",");
		String[] hid = headerid.split(",");

		String webpath = "/file/Temp/";
