...
import org.xianwu.core.metatype.util.TypeCaseHelper;
...
public class Utils {
	...
	private static PropertiesHelper pHelper = PropertiesFactory.getPropertiesHelper(PropertiesFile.GLOBAL);
	...
	* @return 
	*/ 
	public static String getExcelLetterFromIndex(int index) {
		String rs = "";
		index = index + 1;
		do {
			index--;
	...
	* @return 
	*/ 
	public static int getExcelIndexFromLetter(String letter) {
