...
public class ConfigRuleSet extends RuleSetBase {
	 ...
	 * <code>org.xianwu.core.mvc.xstruts.config.ModuleConfig</code> is pushed
	...
	public void addRuleInstances(Digester digester) {
		...
		digester.addSetNext("struts-config/action-mappings/action", "addActionConfig",
				"org.xianwu.core.mvc.xstruts.config.ActionConfig");
		...
		digester.addObjectCreate("struts-config/action-mappings/action/exception",
				"org.xianwu.core.mvc.xstruts.config.ExceptionConfig", "className");
		...
		digester.addSetNext("struts-config/action-mappings/action/exception", "addExceptionConfig",
				"org.xianwu.core.mvc.xstruts.config.ExceptionConfig");
		...
		digester.addSetNext("struts-config/form-beans/form-bean", "addFormBeanConfig",
				"org.xianwu.core.mvc.xstruts.config.FormBeanConfig");

		digester.addObjectCreate("struts-config/form-beans/form-bean/form-property",
				"org.xianwu.core.mvc.xstruts.config.FormPropertyConfig", "className");
		...
		digester.addSetNext("struts-config/form-beans/form-bean/form-property", "addFormPropertyConfig",
				"org.xianwu.core.mvc.xstruts.config.FormPropertyConfig");
		...
		digester.addObjectCreate("struts-config/message-resources",
				"org.xianwu.core.mvc.xstruts.config.MessageResourcesConfig", "className");
		...
		digester.addSetNext("struts-config/message-resources", "addMessageResourcesConfig",
				"org.xianwu.core.mvc.xstruts.config.MessageResourcesConfig");

		digester.addRule("struts-config/message-resources/set-property", new BaseConfigSetPropertyRule());

		digester.addObjectCreate("struts-config/plug-in", "org.xianwu.core.mvc.xstruts.config.PlugInConfig");
		digester.addSetProperties("struts-config/plug-in");
		digester.addSetNext("struts-config/plug-in", "addPlugInConfig",
				"org.xianwu.core.mvc.xstruts.config.PlugInConfig");
 ...
 * <code>org.xianwu.core.mvc.xstruts.config.ModuleConfig</code>.
 * </p>
 */
 ...
 * be a <code>org.xianwu.core.mvc.xstruts.config.ModuleConfig</code>.
 * </p>
 */
