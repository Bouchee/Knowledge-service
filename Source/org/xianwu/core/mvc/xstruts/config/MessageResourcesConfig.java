...
public class MessageResourcesConfig extends BaseConfig {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6766074280041359520L;

	/**
	 * Fully qualified Java class name of the MessageResourcesFactory class we
	 * should use.
	 */
	protected String factory = "org.xianwu.core.mvc.xstruts.util.PropertyMessageResourcesFactory";
