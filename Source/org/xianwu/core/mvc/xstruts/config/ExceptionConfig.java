...
public class ExceptionConfig extends BaseConfig {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3490068150083340781L;
	 ...
	 */
	protected String handler = "org.xianwu.core.mvc.xstruts.action.ExceptionHandler";
	...
	public void inheritFrom(ExceptionConfig config) throws ClassNotFoundException, IllegalAccessException,
		...
		if (getHandler().equals("org.xianwu.core.mvc.xstruts.action.ExceptionHandler")) {
