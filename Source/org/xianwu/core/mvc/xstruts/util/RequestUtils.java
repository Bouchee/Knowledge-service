package org.xianwu.core.mvc.xstruts.util;
...
import org.xianwu.core.mvc.xstruts.action.ActionServletWrapper;
...
import org.xianwu.core.mvc.xstruts.upload.MultipartRequestHandler;
import org.xianwu.core.mvc.xstruts.upload.MultipartRequestWrapper;
...
public class RequestUtils {
	...
	public static void populate(Object bean, String prefix, String suffix, HttpServletRequest request)
		...
		if ((contentType != null) && (contentType.startsWith("multipart/form-data"))
			...
			if (bean instanceof ActionForm) {
				...
				throw new ServletException("bean that's supposed to be "
						...
						+ "\"org.xianwu.core.mvc.xstruts.action.ActionForm\", but type " + "\""
		...
		while (names.hasMoreElements()) {
			...
			// such as 'org.xianwu.core.mvc.xstruts.action.CANCEL'
			if (!(stripped.startsWith("org.xianwu.core.mvc.xstruts."))) {
