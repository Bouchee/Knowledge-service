...
import org.xianwu.core.xml.XmlHelper;
...
public class BaseDto extends HashMap implements Dto, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 9056457957710022232L;
	...
	public String toXml(String pStyle) {
		String strXml = null;
		if (pStyle.equals(Constants.XML_Attribute))
			// 节点属性值风格
			strXml = XmlHelper.parseDto2Xml(this, "root", "row");
		else if (pStyle.equals(Constants.XML_Node))
			// 节点元素值风格
