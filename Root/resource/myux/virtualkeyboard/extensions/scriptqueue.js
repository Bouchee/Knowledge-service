/**
 * $Id: scriptqueue.js 761 2011-05-06 14:13:15Z wingedfox $ $HeadURL: https://svn.debugger.ru/repos/jslibs/BrowserExtensions/tags/BrowserExtensions.029/scriptqueue.js $
 * 
 * Dynamically load scripts and script queues (when load order is important)
 * 
 * *********NOTE******** If you need to load any scripts before ScriptQueue exists, use the following snippet <code>
 ...
 * @class ScriptQueue
 * @param {Function}
 *            optional callback function, called on each successful script load
 * @scope public
 */
ScriptQueue = function(i) {
	...
	var c = function(C) {
		...
		e = e[v];
		if (e && !e[2]) {
			if (C && 'readystatechange' == C.type && 'loading' == this.readyState) {
			} else {
