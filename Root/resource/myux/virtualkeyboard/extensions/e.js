/**
 * $Id: helpers.js 697 2010-11-11 18:54:51Z wingedfox $ $HeadURL: https://svn.debugger.ru/repos/jslibs/BrowserExtensions/tags/BrowserExtensions.029/helpers.js $
 * 
...
(function() {
	...
	if (/WebKit|Khtml/i.test(navigator.userAgent) || (window.opera && parseInt(window.opera.version()) < 9))
		(function() {
			if (!Q)
				if (/loaded|complete/.test(document.readyState) == true) {
					O.trigger(window), Q = true
				} else {
...
DocumentCookie = new function() {
	...
	l.set = function(i, O, Q, _, c, C) {
		if (i) {
			O = escape(O);
			document.cookie = i + "=" + O + (_ ? ";path=" + _ : "") + (Q ? ";NoExp=" + ((Q instanceof Date) ? Q.toGMTString() : new Date(new Date().getTime() + Q * 1000).toGMTString()) : "")
					+ (c ? ";domain=" + c || document.location.domain : "") + (C ? ";secure" : "");
			o[i] = O;
			return true
		}
		return false
	...
	'input' : function(o) {
		...
		O.getContext = function(i) {
			var l = O.getPos(i), _ = i.value, c = _.match(new RegExp("(?:.|[\\r\\n]){0," + (l[0] - 1) + "}(?:^|\\s)", "m")) || "", C = _.match(new RegExp("(?:.|[\\r\\n]){" + l[0] + "}", "m"))[0], e = _
					.replace(C, ""), v = e.substring(0, l[1] - l[0]), V = (e.replace(v, "")).match(/(?:\S|$)*/);
		...
		O.getSelectionOffset = function(I) {
			...
			if ('function' == typeof I.setSelectionRange) {
				...
				Q.innerHTML = (V.substring(0, I.selectionStart - 1) + "<span>" + V.substring(I.selectionStart - 1, I.selectionStart) + "\xa0</span>" + V.substring(I.selectionStart)).replace(/\n/g,
						"<br />").replace(/\t/g, "<em style=\"white-space:pre\">\t</em>");
	...
	'frame' : function() {
		...
		I.getPos = function(i) {
			...
			if ('function' == typeof i.getSelection) {
				var o = i.getSelection(), O = o.anchorNode, Q = o.anchorOffset, _ = o.focusNode, c = o.focusOffset, C = false, e = false, v = 0, V = 0, x, X = i.document.createTreeWalker(
						i.document.body, NodeFilter.SHOW_TEXT, null, false);
