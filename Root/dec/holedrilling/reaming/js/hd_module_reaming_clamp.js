...
Ext
		.onReady(function() {
			...
			var store = new Ext.data.GroupingStore(
					{
						proxy : new Ext.data.HttpProxy(
								{
									url : 'hd_module_reaming_clamp.do?code=queryHd_module_reaming_clamp4Manage'
								// queryHd_module_reaming_clamp4Manage是在Hd_module_reaming_clampAction中的方法queryHd_module_reaming_clamp4Manage;
								}),
			...
			var brandStore = new Ext.data.Store(
					{
						proxy : new Ext.data.HttpProxy(
								{
									url : 'hd_module_reaming_clamp.do?code=queryBrand4Hd_module_reaming_clamp'
								}),
						reader : new Ext.data.JsonReader({
							totalProperty : 'TOTALCOUNT',
							root : 'ROOT'
			...
			var grid = new Ext.grid.GridPanel({
				...
				plugins : [ filters ],
				stateful : sf,
				stateId : 'grid-hd_module_reaming_clamp'
			/*
			 ...
			 * Ext.Window({ title : '机夹刀具刀片性能卡及简图', width : 800, modal : true,
			 ...
			 * 'box', title : '机夹刀具刀片简图', autoEl : { tag : 'iframe', style :
						...
						.confirm(
								...
								function(btn, text) {
									if (btn == 'yes') {
										...
										Ext.Ajax
												.request({
													url : 'hd_module_reaming_clamp.do?code=deleteHd_module_reaming_clamp',
			...
			function submitForm() {
				...
				addItemForm.form
						.submit({
							url : 'hd_module_reaming_clamp.do?code=saveHd_module_reaming_clamp',
							waitTitle : '提示',
							method : 'POST',
			...
			function updateForm() {
				...
				addItemForm.form
						.submit({
							url : 'hd_module_reaming_clamp.do?code=updateHd_module_reaming_clamp',
							waitTitle : '提示',
							method : 'POST',
							submitEmptyText : false,
							waitMsg : '正在处理数据,请稍候...',
							...
							items : [
									{
										...
										listeners : {
											change : function(tf, newValue,
												...
												importpanel.form
														.submit({
															url : 'hd_module_reaming_clamp.do?code=importHd_module_reaming_clampFromExcel',
															waitTitle : '提示',
															method : 'POST',
