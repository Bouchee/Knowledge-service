...
Ext
		.onReady(function() {
			...
			var store = new Ext.data.GroupingStore(
					{
						proxy : new Ext.data.HttpProxy(
								{
									url : 'hd_toolholder_singledrilling_clamp.do?code=queryHd_toolholder_singledrilling_clamp4Manage'
								// queryHd_toolholder_singledrilling_clamp4Manage是在Hd_toolholder_singledrilling_clampAction中的方法queryHd_toolholder_singledrilling_clamp4Manage;
								}),
			...
			var brandStore = new Ext.data.Store(
					{
						proxy : new Ext.data.HttpProxy(
								{
									url : 'hd_toolholder_singledrilling_clamp.do?code=queryBrand4Hd_toolholder_singledrilling_clamp'
								}),
						reader : new Ext.data.JsonReader({
							totalProperty : 'TOTALCOUNT',
							root : 'ROOT'
								...
								},
								{
									...
									listeners : {
										'collapse' : function(obj) {
											addItem.setHeight(addItem
													.getHeight() - 160);
											addItem
													.setPagePosition(
															document.body.clientWidth / 2 - 800 / 2,
			...
			var addItem = new Ext.Window(
					{
						...
						layout : 'fit',
						width : 800,
						height : Ext.isChrome ? 400 : (Ext.isFirefox ? 597
								: 597),
			...
			var grid = new Ext.grid.GridPanel({
				...
				// plugins : [ filters ],
				stateful : sf,
				stateId : 'grid-hd_toolholder_singledrilling_clamp'
			/*
			 ...
			 * Ext.Window({ title : '机夹刀具刀体性能卡及简图', width : 800, modal : true,
			 ...
			 * 'box', title : '机夹刀具刀体简图', autoEl : { tag : 'iframe', style :
						...
						.confirm(
								...
								function(btn, text) {
									if (btn == 'yes') {
										...
										Ext.Ajax
												.request({
													url : 'hd_toolholder_singledrilling_clamp.do?code=deleteHd_toolholder_singledrilling_clamp',
			...
			function submitForm() {
				...
				addItemForm.form
						.submit({
							url : 'hd_toolholder_singledrilling_clamp.do?code=saveHd_toolholder_singledrilling_clamp',
							waitTitle : '提示',
							method : 'POST',
			...
			function updateForm() {
				...
				addItemForm.form
						.submit({
							url : 'hd_toolholder_singledrilling_clamp.do?code=updateHd_toolholder_singledrilling_clamp',
							waitTitle : '提示',
							method : 'POST',
							submitEmptyText : false,
							waitMsg : '正在处理数据,请稍候...',
							...
							items : [
									{
										...
										listeners : {
											change : function(tf, newValue,
												...
												importpanel.form
														.submit({
															url : 'hd_toolholder_singledrilling_clamp.do?code=importHd_toolholder_singledrilling_clampFromExcel',
															waitTitle : '提示',
															method : 'POST',
